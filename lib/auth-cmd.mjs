...
const runShell = async (command) => (await execAsync(command, { maxBuffer: 8 * 1024 * 1024 })).stdout;
...
export async function sessionFromAuthCmd(
  { command, sessionDir, name },
  { shell = runShell, redeem = redeemSignInUrl } = {},
) {
