 ...
 *
 * @param {string} [version] process.versions.node, or any "major.minor.patch".
 * @returns {string | null}
 */
...
/**
 * @param {number} steps
 * @param {string} model "sonnet" or "opus"; anything else is priced as sonnet.
 * @returns {number} euros, rounded to a cent
 */
 ...
 * @param {number | null} [budgetEur]
 * @param {string} [subject] what is being priced; "this run" inside a run, "a map" before one.
 * @returns {string}
 */
