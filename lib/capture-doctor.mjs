...
/**
 * @typedef {import('./capture-types.js').CaptureMetadataInput & {command: string,
 * url?: string | null, mine?: boolean, login?: boolean, authCmd?: string | null}} CaptureArgs
 * @typedef {{url: string, goal: string, server: string, mcpConfig: string, preparation: string}} CaptureCheckOptions
 * @typedef {{command: string, args: string[], env?: Record<string, string>, cwd?: string, disabled?: boolean, type?: string, url?: string}} LocalServer
 */

/** @param {string} command @param {string} cwd @param {NodeJS.ProcessEnv} env */
...
/**
 * @param {CaptureCheckOptions} options
 * @param {{parseArgs: (args: string[]) => CaptureArgs, cwd?: string, env?: NodeJS.ProcessEnv, browser?: () => Promise<void>}} dependencies
 */
